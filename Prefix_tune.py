...
pretrained_model=GPT2LMHeadModel.from_pretrained(pretrained_model_name_or_path=args.cache_dir)
tokenizer=GPT2Tokenizer.from_pretrained(pretrained_model_name_or_path=args.cache_dir)
set_seed(args.seed)
